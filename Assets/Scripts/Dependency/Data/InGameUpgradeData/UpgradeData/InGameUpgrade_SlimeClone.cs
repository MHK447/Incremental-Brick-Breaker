...
public class InGameUpgrade_SlimeClone : InGameUpgrade
{
    protected override void PreInitalize()
    {
        base.PreInitalize();
        upgradeChoiceIndex = (int)Config.InGameUpgradeChoice.SlimeClone;
    }
    ...
    public override void Apply()
    {
        ...
        {
            StatType = Config.InGameUpgradeChoice.SlimeClone,
