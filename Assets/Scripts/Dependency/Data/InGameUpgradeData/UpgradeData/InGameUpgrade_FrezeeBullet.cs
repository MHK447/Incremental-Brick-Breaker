...
public class InGameUpgrade_FrezeeBullet : InGameUpgrade
{
    protected override void PreInitalize()
    {
        base.PreInitalize();
        upgradeChoiceIndex = (int)Config.InGameUpgradeChoice.FreezeBullet;
    }

    public override bool CanSpawn()
    {
        var finddata = GameRoot.Instance.InGameUpgradeSystem.GetModifier(Config.InGameUpgradeChoice.PoisonBullet);
    ...
    public override void Apply()
    {
        ...
        {
            StatType = Config.InGameUpgradeChoice.FreezeBullet,
