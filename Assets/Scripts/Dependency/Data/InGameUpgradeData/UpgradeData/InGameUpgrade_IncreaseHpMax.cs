...
public class InGameUpgrade_IncreaseHpMax : InGameUpgrade
{

    protected override void PreInitalize()
    {
        base.PreInitalize();
        upgradeChoiceIndex = (int)Config.InGameUpgradeChoice.IncreaseHpMax;
    }
    ...
    public override void Apply()
    {
        ...
        {
            StatType = Config.InGameUpgradeChoice.IncreaseHpMax,
