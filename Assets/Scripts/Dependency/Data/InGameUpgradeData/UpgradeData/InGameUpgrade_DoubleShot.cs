...
public class InGameUpgrade_DoubleShot : InGameUpgrade
{
    protected override void PreInitalize()
    {
        base.PreInitalize();
        upgradeChoiceIndex = (int)Config.InGameUpgradeChoice.DoubleShot;
    }
    ...
    public override void Apply()
    {
        ...
        {
            StatType = Config.InGameUpgradeChoice.DoubleShot,
