...
public class InGameUpgrade_SpeedBullet : InGameUpgrade
{
    protected override void PreInitalize()
    {
        base.PreInitalize();
        upgradeChoiceIndex = (int)Config.InGameUpgradeChoice.SpeedBullet;
    }
    ...
    public override void Apply()
    {
        ...
        {
            StatType = Config.InGameUpgradeChoice.SpeedBullet,
