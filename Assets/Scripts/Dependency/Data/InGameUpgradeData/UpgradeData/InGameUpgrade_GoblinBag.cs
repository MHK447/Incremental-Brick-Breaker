...
public class InGameUpgrade_GoblinBag : InGameUpgrade
{
    protected override void PreInitalize()
    {
        base.PreInitalize();
        upgradeChoiceIndex = (int)Config.InGameUpgradeChoice.GoblinBag;
    }
    ...
    public override void Apply()
    {
        ...
        {
            StatType = Config.InGameUpgradeChoice.GoblinBag,
