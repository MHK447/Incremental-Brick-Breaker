...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        [SerializeField] float MarginTopIfNoSafeArea = 0f;
        ...
        void Awake()
        {
            ...
            hasSafeArea = safeArea.y > 0 || safeArea.x > 0 || safeArea.width < Screen.width || safeArea.height < Screen.height;
            ...
            else
            {
                ...
                Panel.offsetMax = new Vector2(0, -MarginTopIfNoSafeArea);
            }
        }
        ...
        void ApplySafeArea(Rect r)
        {
            ...
            else
            {
                ...
                else if (ConformBottom && !ConformTop)
                {
                    r.height += r.y;
