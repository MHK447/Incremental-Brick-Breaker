...
namespace BanpoFri
{
    public class PostProcess
    {
        ...
        public static void OnPostProcessBuild(BuildTarget buildTarget, string buildPath)
        {
            ...
            plist.root.SetString("GIDClientID", "1044374056454-ovv9etn1o17vg5fiin7kgc5qg77sftbf.apps.googleusercontent.com");
            ...
            urlInnerArray.AddString("com.googleusercontent.apps.1044374056454-ovv9etn1o17vg5fiin7kgc5qg77sftbf");

            var urlDict2 = array.AddDict();
            var urlInnerArray2 = urlDict2.CreateArray("CFBundleURLSchemes");
            urlInnerArray2.AddString("banpofriweaponspaceball");
            ...
            capManager.AddAssociatedDomains(new string[]{"applinks:weaponspaceball.onelink.me"});
