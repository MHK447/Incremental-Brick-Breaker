...
{
    private static readonly string DATA_CLASS_FOLDER = "Assets/Scripts/Base/Data/UserDataClass";
    ...
    private static void InitAutoKeyPoint(){
        ...
        if (!AddFindStringData("UserData_Client" , "@변수 자동 등록 위치" , "")){
            string userDataPath = Path.Combine(Application.dataPath, "Scripts", "Base", "Data", $"UserData_Client.cs");
    ...
    private static void AddSaveLoadDataFunc(string fileName , string funcName , string filter , bool addBuilder ){
        ...
        string userDataPath = Path.Combine(Application.dataPath, "Scripts", "Base", "Data", $"{fileName}.cs");
        if (!File.Exists(userDataPath)){
    ...
    {
        string userDataPath = Path.Combine(Application.dataPath, "Scripts", "Base", "Data", "UserData.cs");
        if (!File.Exists(userDataPath))
        {
